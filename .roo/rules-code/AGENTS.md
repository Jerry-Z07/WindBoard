...
- **Thickness Values**: Use Tag values "3", "6", "9" for stroke thickness presets (mapped in XAML lines 175-194).
...
- **Canvas Dimensions**: Fixed at 8000x8000 pixels - do not modify these dimensions without updating scroll logic.